  ...
  return (
    <footer className="bg-gray-950 border-t border-gray-800 py-6 mt-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 gap-4">
        <div className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} Movie Night. All rights reserved.</div>
